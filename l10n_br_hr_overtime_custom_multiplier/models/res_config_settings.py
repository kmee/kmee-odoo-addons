...
class ResConfigSettings(models.TransientModel):
    ...
    business_days_under_2_hours_overtime_multiplier = fields.Char(
        string="Business Days Under 2 Hours Overtime Multiplier",
