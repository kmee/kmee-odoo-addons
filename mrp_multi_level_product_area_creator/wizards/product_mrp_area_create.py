...
class ProductMrpAreaCreate(models.TransientModel):
    ...
    def doit(self):
        ...
        if not self.product_ids:
            raise UserError(self.env._("Selecione ao menos um produto!"))

        if not self.mrp_area_id:
            raise UserError(self.env._("Selecione uma Área MRP!"))
        ...
        if created_records:
            action = {
                ...
                "name": self.env._("Product MRP Areas Criados"),
